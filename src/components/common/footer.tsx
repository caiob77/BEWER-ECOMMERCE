      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">BEWEAR</span>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed">
              Sua loja de moda online com as melhores tendências e qualidade. 
              Descubra seu estilo único com nossa coleção exclusiva.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/produtos" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Produtos
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/lancamentos" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Lançamentos
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/trocas" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Trocas e Devoluções
                </Link>
              </li>
              <li>
                <Link href="/rastreamento" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Rastrear Pedido
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/carreira" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Carreiras
                </Link>
              </li>
              <li>
                <Link href="/imprensa" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Imprensa
                </Link>
              </li>
              <li>
                <Link href="/parceiros" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Parceiros
                </Link>
              </li>
              <li>
                <Link href="/sustentabilidade" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Sustentabilidade
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="max-w-md">
            <h3 className="text-lg font-semibold mb-3">Fique por dentro das novidades</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-6 text-sm text-gray-400">
              <span>© 2025 BEWEAR. Todos os direitos reservados.</span>
            ...
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-400">Formas de pagamento:</span>
              <div className="flex space-x-2">
